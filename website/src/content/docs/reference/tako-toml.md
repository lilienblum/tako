...
- [Quickstart](/docs/quickstart): install and first deploy setup.
- [CLI Reference](/docs/cli): complete command and flag reference.
- [Development](/docs/development): local `tako dev` workflow and env behavior.
- [Deployment](/docs/deployment): remote rollout flow and prerequisites.
...
By default, app name remains adapter/runtime-derived unless you explicitly set `[tako].name`.
