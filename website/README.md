...
- `/`: static landing page
- `/docs`: docs intro alias (redirects to `/docs/the-why`)
- `/docs/the-why`: docs intro page with docs navigation sidebar (mobile hamburger menu)
...
- `/docs/architecture`: how Tako works overview
